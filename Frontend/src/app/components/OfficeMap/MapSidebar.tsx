...
interface DeskItem {
  ...
  x: number | null; /** Posición X del elemento en el canvas (null si no está colocado) */
  y: number | null; /** Posición Y del elemento en el canvas (null si no está colocado) */
  width: number; /** Ancho del elemento en píxeles */
  height: number; /** Alto del elemento en píxeles */
  type: string; /** Tipo de elemento ('desk', 'zone', 'frame', etc.) */
  placed: boolean;  /** Indica si el elemento ya está colocado en el mapa */
